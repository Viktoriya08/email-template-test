			...
			<div class="accordion-order__header" @click="clickHandler">
				...
				<div class="pa-order__head pa-order__grid">
					<div class="pa-order__left">
						<div class="pa-order__number">№12345678</div>
					...
					<div class="pa-order__contact" v-if="contact">
						<div class="pa-order__client">Константин Георгиевич Красильников</div>
					...
					<div class="pa-order__center">
						<div class="pa-order__compound"> Состав заказа:
						...
						<div class="pa-order__imgs">
							...
							<template v-if="quantityMore">
								<div class="pa-order__img pa-order__img--more">+12</div>
							</template>
					...
					<div class="pa-order__info">
						<div class="pa-order__control">
							<div class="pa-order__count"> Итого:
						...
						<div class="pa-order__body"> 
							<template v-if="orderHistory">
								<div class="pa-order__body-detal pa-order-detal">
									<div class="title title--h4 pa-order-detal__title">Заказ покупателя</div>
							...
							<template v-else>
								<div class="pa-order__body-detal pa-order-detal">
									<div class="title title--h4 pa-order-detal__title">Детали заказа</div>
									<div class="pa-order-detal__elem">
										<span class="pa-order-detal__text">Оформлен на</span>
										<span class="pa-order-detal__info">Длинное наименование компании или ФИО физ лица, на которое оформлен заказ</span>
									</div>
									...
									<div class="pa-order-detal__elem pa-order-detal__elem--end">
										<div class="pa-order-detal__box">
											<div class="pa-order-detal__text pa-order-detal__text--grey">Скидка</div>
											<div class="pa-order-detal__text">10%</div>
										</div>
									...
									<div class="pa-order-detal__elem pa-order-detal__elem--end">
										<template v-if="deliveryPoint">
											<div class="pa-order-detal__box">
												<div class="pa-order-detal__text pa-order-detal__text--grey">Способ получения и стоимость</div>
												<div class="pa-order-detal__text">До пункта выдачи СДЭК</div>
												<div class="pa-order-detal__text pa-order-detal__text--grey">г. Челябинск, ул. Строителей, д. 15, кв. 5</div>
											</div>
										...
										<template v-else-if="deliveryCourier">
											<div class="pa-order-detal__box">
												<div class="pa-order-detal__text pa-order-detal__text--grey">Способ получения и стоимость</div>
												<div class="pa-order-detal__text">Курьером по городу</div>
												<div class="pa-order-detal__text pa-order-detal__text--grey">г. Челябинск, ул. Строителей, д. 15, кв. 5</div>
											</div>
										...
										<template v-else> 
											<div class="pa-order-detal__box">
												<div class="pa-order-detal__text pa-order-detal__text--grey">Способ получения и стоимость</div>
												<div class="pa-order-detal__text">Самовывоз</div>
											</div>
							...
							<div class="pa-order__list"> 
								<div class="pa-order-elem">
									...
									<div class="pa-order-elem__info">
										<div class="pa-order-elem__name">Бампер задний Hyundai Solaris 11-13 4D Россия Purple Fantasia PXA (Фиолетовый перламутр)</div>
										<div class="pa-order-elem__data">TYG-Тайвань</div>
										<div class="pa-order-elem__sale">Дисконт</div>
									</div>
									<div class="pa-order-elem__box">
										<div class="pa-order-elem__code">HN04099BB</div>
										<div class="pa-order-elem__quantity">100 шт</div>
									</div>
									<div class="pa-order-elem__price">
										<div class="pa-order-elem__price-new">210 000 ₽</div>
										<div class="pa-order-elem__price-old">212 360 ₽</div>
									</div>
								</div>
								<div class="pa-order-elem">
									<img src="/img/pa/prod.jpg" width="65" height="40" alt="" class="pa-order-elem__img">
